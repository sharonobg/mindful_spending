...
//console.log('comp transactionslistid',transactions)
    ...
    return(
       ...
       <div className="mt-5 bg-white  flex flex-row h-auto p-0 my-0 border border-collapse border-blue-600"> 
            <div className="font-bold border-collapse border border-amber-500 w-[200px] p-2">Month/Day/Year</div>
            <div className="font-bold border-collapse border border-amber-500 w-[200px] p-2 flex-wrap">Category</div>
        ...
        <div key={transaction._id} className="flex flex-col bg-white">
            ...
            (`${props.category}` === 'all-categories' ||  transaction.title == `${props.category}`) && 
                ...
                <div className="border-collapse border border-amber-500 w-[150px] py-2">{parseFloat(transaction?.amount).toFixed(2)}</div>
